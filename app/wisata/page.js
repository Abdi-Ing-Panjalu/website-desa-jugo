...
<section>
      ...
      <Image
        src={irenggolobg} // Replace with your image path
      ...
      >
        ...
        <div className="flex-1 flex-col items-center justify-center ">
          ...
          <p className='my-12 text-center text-lg'> Destinasi singgah favorit ketika mengunjungi kawasan wisata besuki. Menawarkan berbagai makanan dan minuman dengan suguhan pemandangan yang memukau</p>
      ...
      <section className="w-full h-auto bg-white p-8 flex flex-col items-center">
        ...
        <div className="w-full flex justify-center">
          <div className="flex w-full max-w-4xl justify-between">
            <CardWisata
              title="Kelok 9"
              imageUrl={keloksongo} // replace with your image path
              link={"/wisata"}
            />
            <CardWisata
