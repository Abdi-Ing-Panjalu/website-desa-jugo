        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <div className="hidden md:flex items-center space-x-2">
              <a href="#" className="py-5 px-5 text-white hover:text-gray-300">Produk Unggulan</a>
              <a href="#" className="py-5 px-5 text-white hover:text-gray-300">Pemetaan</a>
              <a href="#" className="py-5 px-5 text-white hover:text-gray-300">Wisata</a>
            </div>
          </div>
